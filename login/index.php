...
<body>    
    <div class="container">
        <header>
            <div class="content">
                <div class="title">
                    <a href="main.html" style="color: black;"><img src="../pictures/logo.png"></a>
                ...
                <div class="sign">
                    <h2><form>               
                        <button id="login"><?php if (isset($user)): ?>
                        <?= htmlspecialchars($user["name"]) ?>
                        <?php endif; ?></button>
                        <button id="signup" formaction="logout.php">
                            <?php if (isset($user)): ?>
                            Log out
                        <?php endif; ?>
                        </button>
                        <button id="cart" formaction="../cart.php">Cart</button>
                        <style type="text/css">
                                        .content .sign form {
                                           display: grid; 
